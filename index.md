...
**本书由 NCC China ([.NET Core Community China](https://github.com/dotnetcore)) 的两位成员老农(Github: [303248153](https://github.com/303248153)) 与刘浩杨 (Github: [LiuHaoYang](https://github.com/LiuHaoYang)) 编写。老农曾深入阅读过 CoreCLR 的源代码，在博客园上发表过[系列文章](https://www.cnblogs.com/zkweb/category/935426.html)，并对 Go 运行时的实现有[一定研究](https://www.cnblogs.com/zkweb/category/1108329.html)。刘浩杨是 .NET 的 AOP 框架 [AspectCore](https://github.com/dotnetcore/AspectCore-Framework) 的作者，为著名的 APM 框架 [Apache SkyWalking](https://github.com/apache/incubator-skywalking) 提供了 .NET 支持，并在 2018 年获得微软的 MVP 头衔。**
